"""Recofin platform guide — injected into the agent's Q&A context.
...
PLATFORM_PRINCIPLE = (
    "Recofin works on a single principle: 'Models investigate. Rules authorize. "
...
def _agent_guide() -> str:
    return """THE AGENT / CHAT (bottom-right floating assistant, 'Recofin Agent'):
...
def platform_help() -> str:
    ...
    return "\n\n".join(
        [
            "You are Recofin — an AI Finance Controller for reconciliation. Below is the official guide to the platform. Use it to answer questions about what the platform is, how to navigate it, and how to use it.",
            PLATFORM_PRINCIPLE,
            _pages_guide(),
            _roles_guide(),
            _workflow_guide(),
