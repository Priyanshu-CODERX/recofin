...
Results are persisted to ``tax_matches`` and wired into Recofin's existing
...
class TaxLineMatcher:
    ...
    async def _explain(self, match: TaxMatch) -> str:
        ...
        prompt = f"""You are Recofin's tax investigator. A deterministic check flagged this tax line.
