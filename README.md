...
```bash
git clone https://github.com/Priyanshu-CODERX/recofin.git
cd recofin
...
| `MONGODB_DB`            | `recofin`                  | Database name                                     |
...
2. **Command Center** (`/explore`) — live dashboard metrics.
...
10. **Evaluation** (`/evaluation`) — benchmark Recofin vs `exact_id`, `amount_date`, `fuzzy` baselines.
