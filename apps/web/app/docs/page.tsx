      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-6 border-b border-gray-200 pb-6">
          <div className="flex items-center gap-2 text-emerald-700">
            ...
            <span className="text-xs font-semibold uppercase tracking-wide">Recofin Documentation</span>
          </div>
          <h1 className="mt-2 text-3xl font-bold text-gray-900">How to use Recofin</h1>
        ...
        <Card className="mt-3">
          <CardContent>
            <p className="text-sm text-gray-600">
              Use the floating <strong>Recofin Agent</strong> chat (bottom-right) to ask questions or run tasks. It operates
