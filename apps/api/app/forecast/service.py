...
them, keeping with Recofin's "models investigate, rules authorize" rule.
"""
...
class ForwardCashForecaster:
    ...
    async def commentary(self, forecast: CashForecast, use_ai: bool = True) -> str:
        ...
        prompt = f"""You are Recofin's cash forecaster commentator. A deterministic model produced the figures below.
