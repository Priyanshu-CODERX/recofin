...
> Recofin is an autonomous finance controller. It reconciles financial records, investigates exceptions, and only closes cases when evidence and policy allow it.
...
> Recofin doesn't ask AI to be trusted. It makes AI prove its work.
