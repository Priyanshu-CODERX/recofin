    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
      ...
      <header className="sticky top-0 z-40 border-b bg-white/90 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-bold leading-none">Recofin</p>
      ...
      <section className="border-b bg-gradient-to-b from-emerald-50/60 to-gray-50">
        <div className="mx-auto max-w-4xl px-6 py-20 text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg text-gray-600">
            Recofin reconciles payments, settles discrepancies and forecasts cash — with an AI that
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link href="/explore" className={cn(ctaLg, ctaPrimary)}>
              Explore Recofin <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
      ...
      <section id="how" className="border-y bg-white">
        <div className="mx-auto max-w-6xl px-6 py-20">
          ...
          <h2 className="mt-3 text-center text-3xl font-bold text-gray-900">How Recofin works</h2>
      ...
      <footer className="bg-gray-900">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 py-10 md:flex-row">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-white">Recofin</span>
          </div>
