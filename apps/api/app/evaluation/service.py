...
class EvaluationService:
    ...
    async def run_benchmark(
        ...
        methods = methods or ["exact_id", "amount_date", "fuzzy", "recofin"]
        ...
        for method in methods:
            ...
            if method == "exact_id":
                ...
                predictions = await self._recofin_predictions(all_records, ground_truth)
            else:
                continue
    ...
    async def _recofin_predictions(self, records: list[FinancialRecord], ground_truth: dict) -> dict:
